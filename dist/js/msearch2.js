...
var mSearch2 = {
    ...
    handleSelected: function (input) {
        ...
        switch (input[0].tagName) {
            case 'INPUT':
                ...
                console.log(mSearch2.filters);
                console.log(label);
                console.log('label[for="' + input.prop('id') + '"]');
    ...
    submit: function (params) {
        console.log(this);
        var disableFilter = function(value){
            $("form#mse2_filters").find("label").css({background: value ? "red" : "none"});
            //$("form#mse2_filters").find("input").prop("disabled", value);
        }
            ...
            form.find('input[name="' + config['queryVar'] + '"]').autocomplete({
                source: function (request, callback) {
                    ...
                    $.post(mse2Config['actionUrl'], data, function (response) {
                        console.log("MSEARCH2 request " + new Date(), response);
                        //CatalogSearchController.search.updateLiveSearch(response.data.results);
                      //SearchField.updateLiveSearch(response.data.results);
                      /*
                        if (response['data']['log']) {
                ...
                function (ul, item) {
                    /* !HERE */
                    // console.log($('<label style="display: none;">').data("item.autocomplete", item));
                    return $('<label style="display: none;">').data("item.autocomplete", item);
                };
